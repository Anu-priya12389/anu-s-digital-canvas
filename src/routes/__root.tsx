    ...
    <div className="flex min-h-screen items-center justify-center bg-hero px-4">
      <div className="glass max-w-md rounded-3xl p-10 text-center shadow-glow">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-xl border border-border px-5 py-2.5 text-sm font-semibold">
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Portfolio of Anu Priya — BCA Student & Aspiring Full Stack Developer.",
      },
